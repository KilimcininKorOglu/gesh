# Gesh (𒄑) - Minimal TUI Text Editor
...
LDFLAGS := -ldflags "-s -w -X github.com/KilimcininKorOglu/gesh/pkg/version.Version=$(VERSION) -X github.com/KilimcininKorOglu/gesh/pkg/version.BuildDate=$(BUILD_DATE) -X github.com/KilimcininKorOglu/gesh/pkg/version.Commit=$(COMMIT)"
...
help:
	@echo ""
	@echo "Gesh (𒄑) - Minimal TUI Text Editor"
	@echo "==================================="
